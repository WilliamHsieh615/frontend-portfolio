...
export default {
  template: `
    <div class="col-md-4">
      ...
      <template v-else>
        <ul class="list-group gap-3 mb-3">
          <li class="list-group-item d-flex align-items-center gap-3 flex-wrap" v-for="(item, i) in cart" :key="item.productItem.id">
  ...
  setup(props, { emit }) {
    ...
    return { handleRemoveProduct, handleCheckout, increase, decrease }
  }
}